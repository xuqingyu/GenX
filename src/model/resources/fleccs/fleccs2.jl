...
function fleccs2(EP::Model, inputs::Dict, FLECCS::Int, UCommit::Int, Reserves::Int)
	...
	@constraints(EP, begin
		...
		[y in FLECCS_ALL, i in Absorber_id,t = 1:T],vFLECCS_output[y,i,t] == vCAPTURE[y,t]
		[y in FLECCS_ALL, i in Comp_id, t =1:T],vFLECCS_output[y,i,t] == ePower_use_comp[y,t]	
		[y in FLECCS_ALL, i in Regen_id,t = 1:T],vFLECCS_output[y,i,t] == vREGEN[y,t]
		[y in FLECCS_ALL, i in Rich_id, t =1:T],vFLECCS_output[y,i,t] == vSTORE_rich[y,t]
		[y in FLECCS_ALL, i in Lean_id, t =1:T],vFLECCS_output[y,i,t] == vSTORE_lean[y,t]	
